 ...
 * Date: July 17, 2015
 * */
public class EarthquakeCityMap extends PApplet implements KeyListener {
	...
	// Path to image files
	/*public String oceanImage = "earthquake-image-icon.png";
	public String landImage = "ocean-earthquake-image-icon.png";
	public String cityImage = "city-image-icon.png";*/
	...
	// TODO: Add the method: 
	//  In for loop print out number of earthquakes from numToPrint value
	...
	private void addKey() {	
		...
		//image(cImage, tri_xbase - 10, tri_ybase - 10);
		...
		fill(255, 255, 255);
		// Display image
		//image(lImage, tri_xbase - 7, tri_ybase + 17);
		//image(oImage, tri_xbase - 7, tri_ybase + 37);
		noFill();
		...
		fill(209, 203, 205);
		ellipse(xbase+45, ybase+550, 40, 40);
		text("-", xbase+45, ybase+550);*/
